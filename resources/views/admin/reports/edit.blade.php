...
<div class="card">
    ...
    <form method="POST" action="{{ route('admin.reports.update', $report) }}" enctype="multipart/form-data">
        ...
        <input id="report_year" name="report_year" type="number" min="2000" max="2100" value="{{ old('report_year', $report->report_year) }}">
        ...
        <input id="file" name="file" type="file" accept=".pdf,.doc,.docx,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document">
